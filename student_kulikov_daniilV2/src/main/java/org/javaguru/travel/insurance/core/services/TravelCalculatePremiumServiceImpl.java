...
class TravelCalculatePremiumServiceImpl implements TravelCalculatePremiumService {
    ...
    private void calculatePremium(AgreementDTO agreement) {
        agreementPersonsPremiumCalculator.calculateRiskPremiumsForAllPersons(agreement);
        agreement.setAgreementPremium(agreementTotalPremiumCalculator.calculateTotalAgreementPremium(agreement));
    }
